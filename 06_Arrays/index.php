...
?&gt;
			...
			<div class="navs cf">
				...
				<a href="/CodeDynamicWebsites/CodeDynamicWebsites/05_GetYourHandsDirty" class="button prev">Previous Lecture</a>
				
				<?php } ?>
				
				<a href="/CodeDynamicWebsites/CodeDynamicWebsites/07_AssociativeArrays" class="button next">Next Lecture</a>
			</div><!-- end navs -->
