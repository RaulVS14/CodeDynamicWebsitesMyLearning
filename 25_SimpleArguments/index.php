...
?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/CodeDynamicWebsites/24_CustomFuncions" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/CodeDynamicWebsites/26_Final" class="button next">Next Lecture</a>
			</div><!-- end navs -->
