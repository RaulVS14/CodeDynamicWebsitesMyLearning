...
?&gt;
			...
			<div class="navs cf">
				<a href="/CodeDynamicWebsites/CodeDynamicWebsites/09_GetYourHandsDirty" class="button prev">Previous Lecture</a>
				<a href="/CodeDynamicWebsites/CodeDynamicWebsites/11_Else" class="button next">Next Lecture</a>
			</div><!-- end navs -->
